...
{
    public class RemoveAutonomousInteraction : ImmediateInteraction<Sim, GameObject>
    {
        [DoesntRequireTuning]
        public class Definition : ImmediateInteractionDefinition<Sim, GameObject, RemoveAutonomousInteraction>
        {
            ...
            {
                return !isAutonomous && ServiceUtils.ServiceProfiles.Exists(x => !x.IsImmutable && x.Outputs.Count > 0);
            }
        }
