...
{
    public class AddInventoryObject : ImmediateInteraction<Sim, GameObject>
    {
        [DoesntRequireTuning]
        public class Definition : ImmediateInteractionDefinition<Sim, GameObject, AddInventoryObject>
        {
        ...
        public static readonly string LocalizationKey = typeof(AddInventoryObject).GetLocalizationKey();
        ...
        public override bool Run()
        {
            ...
            {
                profiles[0].TryUIAddInventoryObject();
            }
            return true;
        }
    }
