...
{
    public class DeleteServiceProfile : ImmediateInteraction<Sim, GameObject>
    {
        [DoesntRequireTuning]
        public class Definition : ImmediateInteractionDefinition<Sim, GameObject, DeleteServiceProfile>
        {
        ...
        public static readonly string LocalizationKey = typeof(DeleteServiceProfile).GetLocalizationKey();
