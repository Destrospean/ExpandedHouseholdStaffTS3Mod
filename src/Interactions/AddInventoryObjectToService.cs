            ...
            DebugUtils.TryDisplayScriptError(() =>
                {
                    ...
                    {
                        profiles[0].Inventory.Add(new InventoryObjectCreationParameters(Target.ObjectInstanceName, ResourceUtils.GroupIdToProductVersion(Target.Product.ProductResourceKey.GroupId), 1, Target.GetCurrentPreset()));
                    }
                });
            return true;
        }
